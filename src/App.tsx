      ...
      <div className="min-h-screen bg-[#060608] text-zinc-100 flex flex-col justify-between antialiased font-sans relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full px-6 flex-1 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-24 py-8 relative z-10">
          ...
          <div className="w-full max-w-md bg-[#0c0c0f] border border-zinc-850 p-8 rounded-3xl shadow-xl flex flex-col relative">
            ...
            <p className="text-xs text-zinc-500 text-left mt-1.5 mb-4">
              {authMode === "signin"
            ...
            {!isSupabaseConfigured && (
              <div className="mb-4 p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-xs text-amber-350 leading-relaxed flex flex-col gap-2 text-left">
                <div className="flex items-center gap-2 font-bold font-mono tracking-wider text-[10px] text-amber-400 uppercase">
                ...
                <code className="bg-black/40 p-2 rounded-lg font-mono text-[10px] block break-all text-amber-200">
