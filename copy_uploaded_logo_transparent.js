...
async function generate() {
  const srcPath = 'silencly-logo-transparent.png';
  ...
  await sharpInstance.clone().png().toFile('src/assets/logo.png');
  
  console.log("Uploaded transparent logo copied to all formats!");
}
